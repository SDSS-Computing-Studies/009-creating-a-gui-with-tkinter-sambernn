...
button1.grid(row=1,column=4, sticky=E)
entry1.grid(row=1,column=5, sticky=E)
label2.grid(row=2,column=3)

name.grid(row=4, column=1)
typ.grid(row=4, column=2)
breed.grid(row=4, column=3)
owner.grid(row=4, column=4)
birthdate.grid(row=4, column=5)

enter1.grid(row=5, column=1)
enter2.grid(row=5, column=2)
enter3.grid(row=5, column=3)
enter4.grid(row=5, column=4)
enter5.grid(row=5, column=5)

prev.grid(row=6, column=1, sticky=W)
save.grid(row=6, column=3)
nex.grid(row=6, column=5, sticky=E)
